                    ...
                    <div class="panel-body p-3">
                        <form action="{{ route('register.store') }}" method="POST">
                            ...
                            <div class="form-group py-1 pb-2">
                                <div class="input-field"> 
                                    <span class="fas fa-lock px-2"></span>
                                    <input class="inline-block" name="password_confirmation" type="password" placeholder="Parolni tasdiqlang" required> 
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary btn-block mt-3">Jo'natish</div>
